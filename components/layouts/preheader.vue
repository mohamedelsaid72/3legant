<template>
  <transition name="page">
    <div
      v-if="showOffer"
      class="bg-neutral_02 flex justify-center items-center relative"
    >
      <div class="flex py-3 justify-center items-center gap-1">
        <svg
          width="22"
          height="20"
          viewBox="0 0 22 20"
        ...
        <span class="text-caption1_size text-neutral_05 poppins-semibold"
          >30% off storewide — Limited time!
        </span>
        <nuxt-link
          to="/shop"
          class="hidden text-primary_blue underline ml-2 sm:flex gap-2 items-center"
        >
          Shop Now
          <svg
            width="18"
      ...
      <button
        type="button"
        @click="removeOffer"
        class="absolute top-[50%] translate-y-[-50%] right-[24px]"
      >
        <svg
          width="12"
          height="12"
